...
from gen_data_2d_poisson_boundary import Poisson_2d_boundary_data
from postprocessing_2d_boundary import postprocessing_Poisson_2d_boundary
...
def main():
    ...
    ln.Brain.Start()
    data = Poisson_2d_boundary_data(path)
    ...
    postprocessing_Poisson_2d_boundary(data, ln.Brain.Best_model(), ln.Brain.Loss_history())
    ln.Brain.End()
